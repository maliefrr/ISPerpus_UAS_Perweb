    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md">
                ...
                <form method="POST" action="./controller/insert_buku.php">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="1900" max="2099" step="1" class="form-control" id="tahun_terbit" name="tahun_terbit" required>
                    </div>
