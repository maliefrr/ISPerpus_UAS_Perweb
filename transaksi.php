        ...
        <div class="row">
            ...
            <div class="col-md">
                ...
                <table class="table mt-4">
                    ...
                    <tbody>
                        <?php 
                            $data = $db -> query("SELECT buku.judul_buku,mahasiswa.nama,transaksi.tanggal_peminjaman,transaksi.tanggal_pengembalian FROM buku INNER JOIN transaksi ON transaksi.id_buku = buku.id_buku INNER JOIN mahasiswa ON transaksi.id_mahasiswa = mahasiswa.id_mahasiswa ORDER BY transaksi.tanggal_peminjaman ASC");
                            $number = 1;
